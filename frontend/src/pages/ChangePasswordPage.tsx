...
export default function ChangePasswordPage() {
  ...
  return (
    <div className="min-h-screen bg-[radial-gradient(circle_at_top,#edf8f1_0%,#ffffff_42%,#f8fafc_100%)]">
      ...
      <main className="mx-auto max-w-4xl px-4 py-10 sm:px-6 sm:py-14 lg:px-8 lg:py-16">
        <section className="grid gap-6 lg:grid-cols-[0.85fr_1.15fr]">
          <div className="rounded-[2rem] bg-[linear-gradient(180deg,#111827_0%,#1f2937_100%)] p-6 text-white shadow-[0_55px_140px_-75px_rgba(15,23,42,0.85)] sm:rounded-[2.5rem] sm:p-8">
            <p className="text-[11px] font-black uppercase tracking-[0.3em] text-emerald-200">Segurança</p>
            <h1 className="mt-5 text-3xl font-black tracking-tight sm:text-4xl">Atualize sua senha com segurança.</h1>
            <p className="mt-4 text-sm leading-7 text-slate-200 sm:text-base sm:leading-8">
              Use este fluxo para manter o acesso ativo com credenciais atuais e alinhadas às validações da plataforma.
            </p>
          ...
          <form
            ...
            className="rounded-[2rem] border border-white/80 bg-white/90 p-6 shadow-[0_50px_140px_-75px_rgba(15,23,42,0.65)] backdrop-blur sm:rounded-[2.5rem] sm:p-8"
          >
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-[11px] font-black uppercase tracking-[0.3em] text-emerald-700">Perfil</p>
            ...
            <button
              type="submit"
              disabled={loading}
              className="mt-8 inline-flex w-full items-center justify-center gap-3 rounded-full bg-slate-900 px-6 py-4 text-sm font-black uppercase tracking-[0.22em] text-white shadow-lg shadow-slate-900/15 hover:bg-slate-800 disabled:cursor-not-allowed disabled:opacity-70 sm:w-auto"
            >
